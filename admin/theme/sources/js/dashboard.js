  ...
  if($('#monthly-sales-chart').length) {
    var monthlySalesChart = document.getElementById('monthly-sales-chart').getContext('2d');
      new Chart(monthlySalesChart, {
        type: 'bar',
        data: {
          labels: [$languages["month01"], $languages["month02"], $languages["month03"], $languages["month04"], $languages["month05"], $languages["month06"], $languages["month07"], $languages["month08"], $languages["month09"], $languages["month10"], $languages["month11"], $languages["month12"]],
          datasets: [{
            label: $languages["sales"],
            data: [$ChartOne,$ChartTwo,$ChartThree,$ChartFour,$ChartFive,$ChartSix,$ChartSeven,$ChartEight,$ChartNine,$ChartTen,$ChartEleven,$ChartTwoteen],
