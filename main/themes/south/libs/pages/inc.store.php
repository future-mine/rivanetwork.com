<link rel="stylesheet" href="/main/includes/packages/layouts/store/css/themes/south/<?php echo $_SESSION["themeModeType"]; ?>/style.css?v=<?php echo $_CONFIG["VERSION_NUMBER"]; ?>">
