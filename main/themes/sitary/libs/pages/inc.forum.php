...
<link rel="stylesheet" href="/main/themes/sitary/theme/assets/css/forum.css?v=<?php echo $_CONFIG["VERSION_NUMBER"]; ?>">
<style type="text/css">
...
<div class="row md:p-10">
  <div class="col-md-12">
    <div class="achievement-box mb-3" style="background: <?php echo $themeSitaryVariables["color"]["400"]; ?>;">
...
<div class="row md:p-10">
  <div class="col-md-8 mb-5">
    ...
    <div class="achievement-box" style="background: <?php echo $themeSitaryVariables["color"]["400"]; ?>; <?php echo (($categoryNumber > 1) ? "margin-top: 2rem;" : ""); ?>">
      <div class="achievement-box-info-wrap">
