<link rel="stylesheet" href="/main/includes/packages/layouts/card/css/themes/south/<?php echo $_SESSION["themeModeType"]; ?>/style.css?v=<?php echo $_CONFIG["VERSION_NUMBER"]; ?>">
<?php
