  ...
  <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/jquery.marquee@1.5.0/jquery.marquee.min.js" type="text/javascript"></script>
  ...
  <script type="text/javascript" src="/main/themes/dark/theme/js/theme/in-view.min.js?v=<?php echo $_CONFIG["VERSION_NUMBER"]; ?>"></script>
  <script type="text/javascript" src="/main/themes/dark/theme/js/theme/autosize.min.js?v=<?php echo $_CONFIG["VERSION_NUMBER"]; ?>"></script>
  <script type="text/javascript" src="/main/themes/dark/theme/js/theme/clipboard.min.js?v=<?php echo $_CONFIG["VERSION_NUMBER"]; ?>"></script>
  <script type="text/javascript" src="/main/themes/dark/theme/js/theme/functions.js?v=<?php echo $_CONFIG["VERSION_NUMBER"]; ?>"></script>

  <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/8.11.8/sweetalert2.min.js"></script>
  <script type="text/javascript" src="/main/themes/dark/theme/js/edit.js?v=<?php echo $_CONFIG["VERSION_NUMBER"]; ?>"></script>
  <?php if ($incRequirePage == "chest") { ?>
  <script type="text/javascript" src="/main/includes/packages/layouts/chest/js/dark-edit.js?v=<?php echo $_CONFIG["VERSION_NUMBER"]; ?>"></script>
  ...
  <?php } else if ($incRequirePage == "inventory") { ?>
  <script type="text/javascript" src="/main/includes/packages/layouts/inventory/js/dark-edit.js?v=<?php echo $_CONFIG["VERSION_NUMBER"]; ?>"></script>
  <?php } else if ($incRequirePage == "support" || ($incRequirePage == "profile" && get("action") == "profile" && get("proccess") == "profile")) { ?>
  <script type="text/javascript">
  ...
  <?php } else if ($incRequirePage == "store") { ?>
  <script type="text/javascript" src="/main/includes/packages/layouts/store/js/dark-edit.js?v=<?php echo $_CONFIG["VERSION_NUMBER"]; ?>"></script>
  ...
  <script type="text/javascript" src="/main/themes/dark/theme/js/snow.js?v=<?php echo $_CONFIG["VERSION_NUMBER"]; ?>"></script>
  <?php } ?>
