<!-- JS Libraries -->
  ...
  <script type="text/javascript" src="/main/themes/default/theme/assets/js/edit.js?v=<?php echo $_CONFIG["VERSION_NUMBER"]; ?>"></script>
  <script type="text/javascript" src="/main/themes/default/theme/assets/js/main.js?v=<?php echo $_CONFIG["VERSION_NUMBER"]; ?>"></script>
  <?php if ($themeDefaultVariables["alertModalStatus"] == "1" && !isset($_COOKIE["alertSystemModal"])) { ?>
  <?php setcookie("alertSystemModal", "view", time() + (86400/12)); ?>
  <script type="text/javascript">
    openPanelModal();
  </script>
  <?php } ?>
  ...
  <?php } ?>
  <?php if ($incRequirePage == "profile" || $incRequirePage == "player") { ?>
  <script type="text/javascript" src="https://bs-community.github.io/skinview3d/js/skinview3d.bundle.js"></script>
  <script type="text/javascript" src="/main/themes/default/theme/assets/js/skin.js?v=1"></script>
  <?php } ?>
