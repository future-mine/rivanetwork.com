<section class="py-16">
      ...
      <ol class=" w-full mx-auto px-4 flex space-x-4 sm:px-6 lg:px-8">
        ...
        <li class="flex">
          <div class="flex items-center py-1">
            ...
            <a href="<?php echo urlConverter("abouts", $languageType); ?>" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700"><?php echo languageVariables("abouts", "words", $languageType); ?></a>
          </div>
        </li>
      </ol>
    </nav>
  ...
  <div class="container mx-auto grid lg:grid-cols-12 gap-10 mt-10 px-4 md:px-0">
    <div class="card lg:col-span-12 h-fit">
      <div class="px-6 py-8">
        <h3 class="text-gray-800 fw-bold fs-5"><?php echo languageVariables("abouts", "words", $languageType); ?></h3>
