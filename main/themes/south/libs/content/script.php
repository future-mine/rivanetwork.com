  ...
  <script type="text/javascript">
    ...
    var $messageUsername = "<?php echo ((isset($_SESSION["incAccountLogin"])) ? $readAccount["username"] : "anonim"); ?>";
    ...
    var $themeMode = "<?php echo (($_SESSION["themeModeType"] == "light") ? "default" : "dark") ?>";
    ...
    const $languages = {
      ...
      alertMessageSpam: "<?php echo str_replace('"', '\"', languageVariables("alertMessageSpam", "messages", $languageType)); ?>",
      alertNotMessage: "<?php echo str_replace('"', '\"', languageVariables("alertNotMessage", "messages", $languageType)); ?>",
      alertMessageNone: "<?php echo str_replace('"', '\"', languageVariables("alertMessageNone", "messages", $languageType)); ?>",
      alertMessageNone: "<?php echo str_replace('"', '\"', languageVariables("justNow", "date", $languageType)); ?>"
    };
  ...
  <script type="text/javascript" src="/main/themes/south/theme/js/edit.js?v=<?php echo $_CONFIG["VERSION_NUMBER"]; ?>"></script>
  ...
  <script type="text/javascript" src="/main/themes/south/theme/js/message.js?v=<?php echo $_CONFIG["VERSION_NUMBER"]; ?>"></script>
  <?php } ?>
  <?php if ($readModule["snowModeStatus"] == "1") { ?>
  <script type="text/javascript" src="/main/themes/south/theme/js/snow.js?v=<?php echo $_CONFIG["VERSION_NUMBER"]; ?>"></script>
  <?php } ?>
  <?php if ($_SESSION["themeModeType"] == "dark" && $readTheme["themeColor"] == "0") { ?>
  <script type="text/javascript">
